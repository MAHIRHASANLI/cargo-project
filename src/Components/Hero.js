...
const HeroSection = () => {
    return (
        <section className='lg:h-[90vh] py-12 flex justify-center items-center'>
            <div className='container lg:max-w-[75%] md:max-w-[80%] w-[90%] mx-auto flex items-center justify-between flex-col md:flex-row' >
